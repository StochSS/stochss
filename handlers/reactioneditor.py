...
class ReactionEditorPage(BaseHandler):
    ...
    def get_all_reactions(self):
        ...
        return {'all_reactions': all_reactions, 'all_species': json.dumps(model.getAllSpecies().keys()), 'all_parameters': model.getAllParameters().keys(), 'all_reactants': all_reactants, 'all_products': all_products}
