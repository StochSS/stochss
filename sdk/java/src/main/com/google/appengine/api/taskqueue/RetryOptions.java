 ...
 * {@link RetryOptions} methods may be chained to specify multiple
 * options in the one {@link RetryOptions} object.  <p>Notes on
 * usage:<br> The recommended way to instantiate a {@link
 * RetryOptions} object is to statically import {@link Builder}.* and
 * invoke a static creation method followed by an instance mutator (if
 * needed):
 *
 * <pre>
...
public final class RetryOptions implements Serializable {
  ...
  public String toString() {
    return "RetryOptions[taskRetryLimit=" + taskRetryLimit + ", taskAgeLimitSeconds="
        + taskAgeLimitSeconds + ", minBackoffSeconds=" + minBackoffSeconds + ", maxBackoffSeconds="
        + maxBackoffSeconds + ", maxDoublings=" + maxDoublings + "]";
  }
  ...
  public static final class Builder {
    ...
    /**
     * Returns default {@link RetryOptions} and calls
     * {@link RetryOptions#taskAgeLimitSeconds(long)}.
     */
    ...
    /**
     * Returns default {@link RetryOptions} and calls
     * {@link RetryOptions#minBackoffSeconds(double)}.
     */
    ...
    /**
     * Returns default {@link RetryOptions} and calls
     * {@link RetryOptions#maxBackoffSeconds(double)}.
     */
