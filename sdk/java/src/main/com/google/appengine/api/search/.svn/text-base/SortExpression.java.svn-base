...
public final class SortExpression {
  ...
  public static final class Builder {
     ...
     * {@link SearchApiLimits#MINIMUM_DATE_VALUE} or
     * {@link SearchApiLimits#MAXIMUM_DATE_VALUE} as a default value.
     *
     * @param defaultValue the default value for the field
     * @return this Builder
     */
   ...
   * or no default value for the expression is specified or a default string
   * value is too long
   */
  private SortExpression checkValid() {
    ...
    Preconditions.checkArgument(defaultValueCount == 1,
        "Exactly one default value must be specified for the SortExpression");
    if (defaultValue != null) {
  ...
  public String toString() {
    return String.format("SortExpression(direction=%s%s%s%s)",
        direction,
        Util.fieldToString("expression", expression),
        Util.fieldToString("defaultValue", defaultValue),
        Util.fieldToString("defaultValueNumeric", defaultValueNumeric),
        Util.fieldToString("defaultValueDate", defaultValueDate));
  }
}
