...
public interface Queue {
   ...
   * @param taskName name of the task to delete.
   * @return A {@code Future} whose result is True if the task was sucessfully deleted, False if the
   * task was not found or was previously deleted.
   * @throws IllegalArgumentException if the provided name is null, empty or doesn't match the
   *         expected pattern.
   */
   ...
   *        by a list of TaskHandles.
   * @param taskHandles list of handles of tasks to delete.
   * @return A {@code Future} whose result is a List<Booloean> that represents the result of
   *         deleting each task in the same order as the input handles. True if a task was
   *         sucessfully deleted. False if the task was not found or was previously deleted.
   * @throws IllegalArgumentException if the provided name is null, empty or doesn't match the
   *         expected pattern.
   * @throws QueueNameMismatchException if the task handle refers to a different named queue.
   */
   ...
   * task and make it avaible to be leased by calling {@link #leaseTasks(LeaseOptions) leaseTasks}.
   ...
   * @throws IllegalArgumentException if deadlineInSeconds <= 0.
