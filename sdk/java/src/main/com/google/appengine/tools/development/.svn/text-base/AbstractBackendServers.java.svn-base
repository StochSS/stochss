...
public abstract class AbstractBackendServers implements BackendContainer,
  ...
  private ServerConfigurationHandle serverConfigurationHandle;
  ...
  @Override
  public void init(String address, ServerConfigurationHandle serverConfigurationHandle,
  ...
  public void configureAll(ApiProxyLocal local) throws Exception {
    BackendsXml backendsXml = serverConfigurationHandle.getBackendsXml();
    if (backendsXml == null) {
