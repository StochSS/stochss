...
sudo docker run -it -p 8083:8080 -p 8000:8000 -p 9999:9999 --name=stochsscontainer1_8_dev --volume `pwd`:/stochss-master aviralcse/stochss_qsub sh -c "apt-get install -yy docker; pip install docker-py; cd /stochss-master; bash"
