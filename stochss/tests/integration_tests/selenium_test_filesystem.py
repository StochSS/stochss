...
class TestFilesystem(unittest.TestCase):
    ...
    def test_filesystem(self):
        ...
        self.driver.find_element(By.CSS_SELECTOR, ".info .btn-secondary").click()
        ...
        #test upload file
        self.driver.find_element(By.CSS_SELECTOR, "b").click()
        self.driver.find_element(By.CSS_SELECTOR, ".dropdown-item:nth-child(7)").click()
        title=self.driver.find_element_by_class_name("modal-title")
        assert title.text=='Upload a file'
        self.driver.find_element(By.CSS_SELECTOR, ".info .btn-secondary").click()

        #test collapse/expand jstree
        self.driver.find_element(By.CSS_SELECTOR, "#j1_1 > .jstree-icon").click()
        jstree_nodes=self.driver.find_elements_by_class_name("jstree-node")
        assert 1 == len(jstree_nodes)
        self.driver.find_element(By.CSS_SELECTOR, ".jstree-ocl").click()
        jstree_nodes=self.driver.find_elements_by_class_name("jstree-node")
        ...
        time.sleep(1)
        self.driver.find_element(By.LINK_TEXT, "To Notebook").click()
        notebook_window_handle = self.wait_for_window(5000)
        root_handle = self.driver.current_window_handle
        self.driver.switch_to.window(notebook_window_handle)
        assert self.driver.find_element_by_id("ipython_notebook")
        self.driver.close()
        self.driver.switch_to.window(root_handle)
