...
class TestGenerate_Zip_File(unittest.TestCase):
    ...
    def test_get_zip_file_data(self):
        with unittest.mock.patch("builtins.open",unittest.mock.mock_open(read_data="foo")) as mock_open:
    ...
    def test_download_zip_file_calls_generate_zip_file(self):
        ...
        with unittest.mock.patch("os.path.exists"):
            with unittest.mock.patch("handlers.util.generate_zip_file.get_unique_file_name",\
                ...
                with unittest.mock.patch("handlers.util.generate_zip_file.generate_zip_file") as mock_generate:
